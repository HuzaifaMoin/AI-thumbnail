...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                AI thumbnail Generator for your <span className="move-gradient px-3 rounded-xl text-nowrap">Youtube videos.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                No complexity. No noise. Just clean, reliable automated thumbnail generation.</motion.p>
