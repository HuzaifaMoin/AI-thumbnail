...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to="/" className="font-bold text-lg gap-1 text-white">
                <img src="/logo.avif" alt="AI Thumbnail Generator Logo" className="w-10 h-8 inline-block mr-2 border border-white rounded-full" />
                Huzaifa
                </Link>
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    <Link to ="#" className="text-gray-500 hover:text-pink-600 transition">
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <Link to="/" className="text-gray-500 hover:text-pink-600 transition">AI Thumbnail Generator</Link></p>
            </motion.div>
        </footer>
    );
}