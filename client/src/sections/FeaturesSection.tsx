    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Experience the future of thumbnail creation with our AI Thumbnail Generator.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        <img className="h-full w-auto" src={featuresShowcase1} alt="features showcase" width={1000} height={500} />
                    </motion.div>
